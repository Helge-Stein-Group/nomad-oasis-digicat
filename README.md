![docker image](https://github.com/Helge-Stein-Group/nomad-oasis-digicat/actions/workflows/docker-publish.yml/badge.svg)


# Helge-Stein-Group's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of Helge-Stein-Group.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/Helge-Stein-Group/nomad-oasis-digicat.git
    cd nomad-oasis-digicat
    ```

    or

    ```sh
    curl-L -o nomad-oasis-digicat.zip "https://github.com/Helge-Stein-Group/nomad-oasis-digicat/archive/main.zip"
    unzip nomad-oasis-digicat.zip
    cd nomad-oasis-digicat
    ```
...
your `docker-compose.yaml` with `ghcr.io/helge-stein-group/nomad-oasis-digicat:main` for the services
...
```
docker pull ghcr.io/helge-stein-group/nomad-oasis-digicat/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/Helge-Stein-Group/nomad-oasis-digicat/manifests/main": unauthorized`
